...
"""
 ____             _       __  __               _
|  _ \ __ _ _   _| | ___ |  \/  | ___  ___ ___(_) __ _ ___
| |_) / _` | | | | |/ _ \| |\/| |/ _ \/ __/ __| |/ _` / __|
|  __/ (_| | |_| | | (_) | |  | |  __/\__ \__ \ | (_| \__ \

|_|   \__,_|\__,_|_|\___/|_|  |_|\___||___/___/_|\__,_|___/
        Feito Por PauloMessias -> +50k BOTNETS
"""
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				print "Numero de requisicoes enviadas %s" % (request_counter)
				previous=request_counter
		if flag==2:
			print "\n - Site morreu, com excessao de pacotes..."
